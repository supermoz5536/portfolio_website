    ...
    const handleTouchStart = (event: TouchEvent) => {
      if (isActicatedRef.current) {
        ...
        touchStartTimeoutRef.current = setTimeout(() => {
          ...
          const scene3Element = document.getElementById("scene3");
          padRef.current.style.top =
            event.touches[0].pageY - scene3Element!.offsetLeft + "px";
  ...
  function alignAndConfigPad() {
    if (padRef.current && handleRef.current) {
      ...
      regionData = {
        ...
        localOffset: {
          top: regionBodyOffsetTop - scene3Element!.offsetTop, // #scene3(0, 0)との距離
          left: regionBodyOffsetLeft,
        },
