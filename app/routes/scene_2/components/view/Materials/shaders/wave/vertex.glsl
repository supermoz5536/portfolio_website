...
void main() {
    ...
    float elevation = sin(modelPosition.x * uBigWavesFrequency.x + uElapseTime * uBigWavesSpeed.x) *
                      sin(modelPosition.z * uBigWavesFrequency.y + uElapseTime * uBigWavesSpeed.y) *
                      uBigWavesElevation;     
